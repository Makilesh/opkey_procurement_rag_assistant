...
# Asked when retrieval's best match is weak — better to confirm what the user
# wants than to answer confidently from a shaky match.
CLARIFY_RESPONSE = (
    "I want to answer the right thing rather than guess — your question is a bit broad "
    "for what I have, so could you narrow it down? I can help from either of two "
    "documents:\n\n"
    "- the **Oracle Fusion Procurement guide** — how to *do* things in the software "
    "(requisitions, purchase orders, approval routing, agreements), or\n"
    "- the **University of Richmond procurement policy** — the *rules* (dollar "
    "thresholds, competitive-bid limits, signature authority).\n\n"
    "Which of these did you have in mind, or can you rephrase a little more specifically? "
    "You can also pick a document from the \"📚 Search in\" menu and ask again."
)
